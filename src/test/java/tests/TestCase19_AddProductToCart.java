...
public class TestCase19_AddProductToCart extends BaseTest {

	@Test(priority = 0, groups = "pageIsVisible")
	private void verifyHomePageIsVisibleSuccessfully() {
		logger.info("Stating test case : AddProductToCart");
	...
	@Test(priority = 1, dataProvider = "testdata", dataProviderClass = BaseTest.class, groups = "pageIsVisible")
	...
	@Test(priority = 2, groups = "pageIsVisible")
